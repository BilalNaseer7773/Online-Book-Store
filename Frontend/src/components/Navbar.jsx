            ...
            <nav className="flex justify-between items-center">
                ...
                <div className="flex items-center md:gap-16 gap-4">
                    ...
                    <div className="relative sm:w-72 w-40 space-x-2">
                        ...
                        className="bg-[#EAEAEA] w-full py-1 md:px-8 px-6 rounded-md focus:outlilne-none"/>
                    </div>
                </div>
                    ...
                    <div> 
                        {
                            ...
                            <button onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
                                <img src={avatarImg} alt="" className={`size-7 rounded-full ${currentUser ? 'ring-2 ringblue-500' : ''}`}/>
                            </button>
                            {/*Show Dropdown */}
                            {
                                isDropdownOpen && (
